  ...
  return (
    ...
    <div className='about-right'>
        <h2>ABOUT UNIVERSITY</h2>
          ...
          <p>• Offers 827 number of Diploma, Undergraduate, Postgraduate and Doctoral Programmes in Engineering, Business Management, Pharmacy, Biotechnology, Microbiology, Arts, Sciences, Commerce, Hotel Management & Catering Technology, Law, Education, Journalism & Mass Communication, Agricultural Science & Engineering and Computer Science & Applications, etc..</p>
